...
import '../../blocs/update_user_bloc/update_user_event.dart';
import '../../blocs/update_user_bloc/update_user_state.dart';

class UpdateUserPageBody extends StatelessWidget {
   UpdateUserPageBody({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UpdateUserBloc, UpdateUserState>(
        builder: (context, state) {
          ...
          return const Text('Update User Error');
        });
  }
}